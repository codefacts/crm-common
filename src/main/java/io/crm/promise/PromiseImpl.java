...
final public class PromiseImpl<T> implements Promise<T>, Defer<T> {
    ...
    @Override
    public <R> Promise<R> mapPromise(MapPromiseHandler<T, R> promiseHandler) {
    ...
    @Override
    public Promise<Void> then(ThenHandler<T> thenHandler) {
